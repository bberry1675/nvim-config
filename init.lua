    ...
    { -- Useful plugin to show you pending keybinds.
        ...
        opts = {
            ...
            spec = {
                ...
                { '<leader>bg', group = 'Goto', mode = { 'n', 'v' } },
                { '<leader>z', group = 'Surround', mode = { 'n', 'v' } },
                { '<leader>m', group = 'Session', mode = { 'n' } },
                { '<leader>bc', group = 'Close', mode = { 'n', 'v' } },
            },
        },
    },
